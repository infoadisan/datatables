...
using Action = DatatablesCore.Repository.Models.Action;

namespace DatatablesCore.Repository;

public partial class BronoPlusdbcontext : DbContext
{
    public BronoPlusdbcontext()
    {
    }

    public BronoPlusdbcontext(DbContextOptions<BronoPlusdbcontext> options)
        : base(options)
    {
    }
